...
export class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('background-mountains', `/assets/background-mountains@${fiksForPikselratio(1)}.png`);
    this.load.image('background-snow', `/assets/background-snow@${fiksForPikselratio(1)}.png`);
